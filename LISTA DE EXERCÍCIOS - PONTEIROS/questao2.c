...
//p = &x; e) Após modificar o código conforme indicado, se você compilar e executar o programa, a execução será bem-sucedida. A mensagem de erro não será mais emitida, e o programa imprimirá o valor de p (o endereço de x) e o valor de *p (o valor armazenado em x).

#include <stdio.h>

int main(void) {
int x, *p; x = 100; p = &x;
printf("Valor de p = %p\tValor de *p = %d", (void *)p, *p); return 0; }
